...
var _user$project$RPWeb_RollMsgs$InProcessROsMsg = {ctor: 'InProcessROsMsg'};
var _user$project$RPWeb_RollMsgs$ActionRequiredROsMsg = {ctor: 'ActionRequiredROsMsg'};

var _user$project$RPWeb_Models$inProcessinitialModel = {roList: _krisajenkins$remotedata$RemoteData$Loading, ranNumb: 8, rollMsg: _user$project$RPWeb_RollMsgs$InProcessROsMsg};
var _user$project$RPWeb_Models$actionRequiredInitialModel = {roList: _krisajenkins$remotedata$RemoteData$Loading, ranNumb: 5, rollMsg: _user$project$RPWeb_RollMsgs$ActionRequiredROsMsg};
var _user$project$RPWeb_Models$InProcessRO = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {repairOrderNumber: a, aggregateRootId: b, customerNumber: c, customerName: d, branchNumber: e, branchDepartmentNumber: f, bay: g, dashboardPriority: h, priority: i, unitNumber: j, unitVehicleIdNumber: k, internalStatus: l, technicians: m, driverWaiting: n, isPortalUser: o, timeZoneDisplay: p, estimatedWorkFinish: q};
																};
															};
														};
													};
...
var _user$project$RPWeb_Models$ActionRequiredRO = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _user$project$RPWeb_Models$Technician = F2(
	function (a, b) {
		return {text: a, value: b};
	});
var _user$project$RPWeb_Models$ROListModel = F3(
	function (a, b, c) {
		return {roList: a, ranNumb: b, rollMsg: c};
	});

var _user$project$RPWeb_Msgs$Roll = function (a) {
	return {ctor: 'Roll', _0: a};
};
var _user$project$RPWeb_Msgs$Refresh = function (a) {
	return {ctor: 'Refresh', _0: a};
};
var _user$project$RPWeb_Msgs$OnFetchInProcessROs = function (a) {
	return {ctor: 'OnFetchInProcessROs', _0: a};
};
var _user$project$RPWeb_Msgs$OnFetchActionRequiredROs = function (a) {
	return {ctor: 'OnFetchActionRequiredROs', _0: a};
};

var _user$project$RPWeb_InProcessCommand$techniciansDecoder = A3(
	...
	A3(
		...
		'text',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$RPWeb_Models$Technician)));
var _user$project$RPWeb_InProcessCommand$inProcessROsDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'estimatedWorkFinish',
		...
		A3(
			...
			A3(
				...
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'technicians',
					_elm_lang$core$Json_Decode$list(_user$project$RPWeb_InProcessCommand$techniciansDecoder),
					A3(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
						'internalStatus',
						_elm_lang$core$Json_Decode$string,
														...
														A3(
															...
															A3(
																...
																A3(
																	...
																	'repairOrderNumber',
																	_elm_lang$core$Json_Decode$int,
																	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$RPWeb_Models$InProcessRO))))))))))))))))));
var _user$project$RPWeb_InProcessCommand$fetchInProcessROsDecoder = _elm_lang$core$Json_Decode$list(_user$project$RPWeb_InProcessCommand$inProcessROsDecoder);
var _user$project$RPWeb_InProcessCommand$fetchInProcessROsUrl = 'https://testfuncappsuresh.azurewebsites.net/api/loadInProcessROs?code=kCigay9kCfy2nr0ui7yzI0jDinaC0TiBmBTcBEawoPzPxyNMCbTsug==';
var _user$project$RPWeb_InProcessCommand$fetchInProcessROs = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$RPWeb_Msgs$OnFetchInProcessROs,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$RPWeb_InProcessCommand$fetchInProcessROsUrl, _user$project$RPWeb_InProcessCommand$fetchInProcessROsDecoder)));
var _user$project$RPWeb_InProcessCommand$startRandomInProcessROsFetch = A2(
	_elm_lang$core$Random$generate,
	_user$project$RPWeb_Msgs$Refresh,
	A2(_elm_lang$core$Random$int, 1, 16));

var _user$project$RPWeb_ActionRequiredCommand$techniciansDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'value',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$RPWeb_Models$Technician)));
var _user$project$RPWeb_ActionRequiredCommand$roDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'estimatedWorkFinish',
	_elm_lang$core$Json_Decode$nullable(_elm_lang$core$Json_Decode$string),
	A3(
		...
		A3(
			...
			A3(
				...
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'technicians',
					_elm_lang$core$Json_Decode$list(_user$project$RPWeb_ActionRequiredCommand$techniciansDecoder),
					A3(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
						'internalStatus',
						_elm_lang$core$Json_Decode$string,
														...
														A3(
															...
															A3(
																...
																A3(
																	...
																	'repairOrderNumber',
																	_elm_lang$core$Json_Decode$int,
																	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$RPWeb_Models$ActionRequiredRO))))))))))))))))));
var _user$project$RPWeb_ActionRequiredCommand$fetchhRODecoder = _elm_lang$core$Json_Decode$list(_user$project$RPWeb_ActionRequiredCommand$roDecoder);
var _user$project$RPWeb_ActionRequiredCommand$fetchhROUrl = 'https://testfuncappsuresh.azurewebsites.net/api/loadInProcessROs?code=kCigay9kCfy2nr0ui7yzI0jDinaC0TiBmBTcBEawoPzPxyNMCbTsug==';
var _user$project$RPWeb_ActionRequiredCommand$fetchActionRequiredROs = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$RPWeb_Msgs$OnFetchActionRequiredROs,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$RPWeb_ActionRequiredCommand$fetchhROUrl, _user$project$RPWeb_ActionRequiredCommand$fetchhRODecoder)));
var _user$project$RPWeb_ActionRequiredCommand$startRandomActionRequiredROsFetch = A2(
	_elm_lang$core$Random$generate,
	_user$project$RPWeb_Msgs$Refresh,
	A2(_elm_lang$core$Random$int, 1, 4));

var _user$project$RPWeb_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'OnFetchInProcessROs':
				return {
					ctor: '_Tuple2',
			...
			case 'Roll':
				...
				var mdl = _elm_lang$core$Native_Utils.update(
					...
					{rollMsg: _p2});
				var _p1 = _p2;
				if (_p1.ctor === 'InProcessROsMsg') {
					return {ctor: '_Tuple2', _0: mdl, _1: _user$project$RPWeb_InProcessCommand$startRandomInProcessROsFetch};
				} else {
					return {ctor: '_Tuple2', _0: mdl, _1: _user$project$RPWeb_ActionRequiredCommand$startRandomActionRequiredROsFetch};
				}
			default:
				var mdl = _elm_lang$core$Native_Utils.update(
					model,
					{ranNumb: _p0._0});
				var _p3 = model.rollMsg;
				if (_p3.ctor === 'InProcessROsMsg') {
					return {ctor: '_Tuple2', _0: mdl, _1: _user$project$RPWeb_InProcessCommand$fetchInProcessROs};
				} else {
					return {ctor: '_Tuple2', _0: mdl, _1: _user$project$RPWeb_ActionRequiredCommand$fetchActionRequiredROs};
				}
		}
	});

var _user$project$RPWeb_Views_List$roTechnicianOptionBuilder = function (technician) {
	return A2(
		_elm_lang$html$Html$option,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$value(technician.value),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(technician.text),
			_1: {ctor: '[]'}
		});
};
var _user$project$RPWeb_Views_List$inProcessRORowView = function (inProcessRO) {
	var convertedEstimatedFWorkFinish = function () {
		var _p0 = inProcessRO.estimatedWorkFinish;
		if (_p0.ctor === 'Just') {
			return _p0._0;
		} else {
			return _elm_lang$core$Basics$toString(inProcessRO.timeZoneDisplay);
		}
	}();
	var portalCustomerIndicator = _elm_lang$core$Native_Utils.eq(inProcessRO.isPortalUser, 1) ? A2(
		...
		{ctor: '[]'},
		{
			...
			_0: _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'*',
					_elm_lang$core$Basics$toString(inProcessRO.customerNumber))),
			_1: {ctor: '[]'}
		}) : A2(
	...
	var roLinkText = _elm_lang$core$Native_Utils.eq(inProcessRO.repairOrderNumber, 0) ? 'Appt' : _elm_lang$core$Basics$toString(inProcessRO.repairOrderNumber);
	var priorityValue = _elm_lang$core$Native_Utils.eq(inProcessRO.priority, -1) ? A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
		...
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(inProcessRO.priority)),
			_1: {ctor: '[]'}
		});
	var dashBoardPriorityColorScheme = _elm_lang$core$Native_Utils.eq(inProcessRO.dashboardPriority, 1) ? 'alert-blue' : (_elm_lang$core$Native_Utils.eq(inProcessRO.dashboardPriority, 2) ? 'alert-green' : (_elm_lang$core$Native_Utils.eq(inProcessRO.dashboardPriority, 3) ? 'alert-yellow' : (_elm_lang$core$Native_Utils.eq(inProcessRO.dashboardPriority, 4) ? 'alert-red' : 'alt')));
	return A2(
		_elm_lang$html$Html$tr,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(dashBoardPriorityColorScheme),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('row-id'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$type_('hidden'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(inProcessRO.aggregateRootId),
									_1: {ctor: '[]'}
								}
							}
						},
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(inProcessRO.dashboardPriority)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(inProcessRO.branchNumber)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(inProcessRO.branchDepartmentNumber)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('Bay'),
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'width: 25px'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$id(
																A2(_elm_lang$core$Basics_ops['++'], 'bay-', inProcessRO.aggregateRootId)),
															_1: {ctor: '[]'}
														}
													}
												}
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(roLinkText),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
										...
										},
										{
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'font-weight: bold'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(inProcessRO.customerName),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
									...
									_1: {
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(inProcessRO.unitNumber),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(inProcessRO.unitVehicleIdNumber),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(inProcessRO.internalStatus),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
													...
													_0: A2(
														...
														},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$id('roTech1Options'),
																	_1: {
																		ctor: '::',
																...
																A2(_elm_lang$core$List$map, _user$project$RPWeb_Views_List$roTechnicianOptionBuilder, inProcessRO.technicians)),
															_1: {
																ctor: '::',
																_0: A2(
																	_elm_lang$html$Html$select,
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$id('roTech2Options'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$width(30),
																			_1: {ctor: '[]'}
													...
													_1: {
														...
														_0: A2(
															...
															{ctor: '[]'},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('DriverWaiting'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$id(
																				A2(_elm_lang$core$Basics_ops['++'], 'dw-', inProcessRO.aggregateRootId)),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$name('DriverWaiting'),
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$type_('checkbox'),
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$checked(inProcessRO.driverWaiting),
																						_1: {ctor: '[]'}
																					}
																				}
																			}
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(convertedEstimatedFWorkFinish),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
...
var _user$project$RPWeb_Views_List$buildROsTableColumnHeadersV2 = function (_p1) {
	var _p2 = _p1;
	return A2(
...
var _user$project$RPWeb_Views_List$buildROsTableColumnHeaders = F2(
	function (textValue, widthValue) {
		return A2(
			_elm_lang$html$Html$th,
			{
				ctor: '::',
				_0: A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(widthValue),
						'px')),
				_1: {ctor: '[]'}
			},
			{
...
var _user$project$RPWeb_Views_List$rolegend = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('dashboard-legend-blue'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(' Waiting on Parts/Sublet'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('dashboard-legend-green'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(' Parts/Sublet Arrival Time'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('dashboard-legend-yellow'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(' Work in Process/Over Estimate'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('dashboard-legend-red'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text(' Past ETC'),
											_1: {ctor: '[]'}
										}
									}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('dashboard-legend-bolditalic'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Bold Italicized'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text('= Portal User'),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
...
var _user$project$RPWeb_Views_List$buildROstable = function (inProcessRORows) {
	var headerWidthPairs = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'Priority', _1: 25},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'Sev', _1: 25},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'B', _1: 25},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'D', _1: 25},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'Bay', _1: 25},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'RO#', _1: 75},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'Cust#', _1: 30},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'Customer', _1: 220},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'Unit', _1: 35},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'VIN', _1: 35},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'Status', _1: 100},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'Updated', _1: 0},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'Tech# 1', _1: 75},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: '#2', _1: 50},
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'DW', _1: 25},
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'ETC', _1: 75},
																	_1: {ctor: '[]'}
																}
															}
														}
	...
	var combinedResult = A3(
		_elm_lang$core$List$map2,
		F2(
			function (columnName, width) {
				return {ctor: '_Tuple2', _0: columnName, _1: width};
			}),
		rOsTableColumnList,
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('searchContainer'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$RPWeb_Views_List$rolegend,
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$table,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('searchList'),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									A2(
										_elm_lang$core$List$map,
										_user$project$RPWeb_Views_List$buildROsTableColumnHeadersV2,
										A3(
											_elm_lang$core$List$map2,
											F2(
												function (columnName, width) {
						...
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								A2(_elm_lang$core$List$map, _user$project$RPWeb_Views_List$inProcessRORowView, inProcessRORows)),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$RPWeb_Views_List$maybeList = function (model) {
	var _p3 = model.roList;
	switch (_p3.ctor) {
		case 'NotAsked':
		...
		case 'Success':
			return _user$project$RPWeb_Views_List$buildROstable(
				A2(_elm_lang$core$List$take, model.ranNumb, _p3._0));
		default:
			return _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(_p3._0));
	}
};
var _user$project$RPWeb_Views_List$view = function (model) {
	return _user$project$RPWeb_Views_List$maybeList(model);
};

var _user$project$RPWeb_Views_View$page = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							' Total rows: ',
							_elm_lang$core$Basics$toString(model.ranNumb))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$RPWeb_Msgs$Roll(_user$project$RPWeb_RollMsgs$InProcessROsMsg)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Refresh in process ro list'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$button,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$RPWeb_Msgs$Roll(_user$project$RPWeb_RollMsgs$ActionRequiredROsMsg)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Refresh action required ro list'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: function () {
									var _p0 = model.rollMsg;
									if (_p0.ctor === 'InProcessROsMsg') {
										return _elm_lang$html$Html$text('In Process ROs');
									} else {
										return _elm_lang$html$Html$text('Action Required ROs');
									}
								}(),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$project$RPWeb_Views_List$view(model),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$RPWeb_Views_View$view = function (model) {
	return _user$project$RPWeb_Views_View$page(model);
};

var _user$project$ActionRequired$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$ActionRequired$init = {ctor: '_Tuple2', _0: _user$project$RPWeb_Models$actionRequiredInitialModel, _1: _user$project$RPWeb_ActionRequiredCommand$startRandomActionRequiredROsFetch};
var _user$project$ActionRequired$main = _elm_lang$html$Html$program(
	{init: _user$project$ActionRequired$init, view: _user$project$RPWeb_Views_View$view, update: _user$project$RPWeb_Update$update, subscriptions: _user$project$ActionRequired$subscriptions})();

var Elm = {};
Elm['ActionRequired'] = Elm['ActionRequired'] || {};
if (typeof _user$project$ActionRequired$main !== 'undefined') {
    _user$project$ActionRequired$main(Elm['ActionRequired'], 'ActionRequired', {"types":{"message":"RPWeb.Msgs.Msg","aliases":{"RPWeb.Models.InProcessRO":{"type":"{ repairOrderNumber : Int , aggregateRootId : String , customerNumber : Int , customerName : String , branchNumber : Int , branchDepartmentNumber : Int , bay : Maybe.Maybe String , dashboardPriority : Int , priority : Int , unitNumber : String , unitVehicleIdNumber : String , internalStatus : String , technicians : List RPWeb.Models.Technician , driverWaiting : Bool , isPortalUser : Int , timeZoneDisplay : String , estimatedWorkFinish : Maybe.Maybe String }","args":[]},"RPWeb.Models.ActionRequiredRO":{"type":"{ repairOrderNumber : Int , aggregateRootId : String , customerNumber : Int , customerName : String , branchNumber : Int , branchDepartmentNumber : Int , bay : Maybe.Maybe String , dashboardPriority : Int , priority : Int , unitNumber : String , unitVehicleIdNumber : String , internalStatus : String , technicians : List RPWeb.Models.Technician , driverWaiting : Bool , isPortalUser : Int , timeZoneDisplay : String , estimatedWorkFinish : Maybe.Maybe String }","args":[]},"RemoteData.WebData":{"type":"RemoteData.RemoteData Http.Error a","args":["a"]},"Http.Response":{"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }","args":["body"]},"RPWeb.Models.Technician":{"type":"{ text : String, value : String }","args":[]}},"unions":{"Dict.NColor":{"tags":{"Black":[],"BBlack":[],"Red":[],"NBlack":[]},"args":[]},"Http.Error":{"tags":{"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"],"BadUrl":["String"],"NetworkError":[]},"args":[]},"RPWeb.RollMsgs.RollMsg":{"tags":{"ActionRequiredROsMsg":[],"InProcessROsMsg":[]},"args":[]},"Dict.LeafColor":{"tags":{"LBlack":[],"LBBlack":[]},"args":[]},"Maybe.Maybe":{"tags":{"Nothing":[],"Just":["a"]},"args":["a"]},"Dict.Dict":{"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]},"args":["k","v"]},"RemoteData.RemoteData":{"tags":{"Failure":["e"],"NotAsked":[],"Success":["a"],"Loading":[]},"args":["e","a"]},"RPWeb.Msgs.Msg":{"tags":{"OnFetchActionRequiredROs":["RemoteData.WebData (List RPWeb.Models.ActionRequiredRO)"],"OnFetchInProcessROs":["RemoteData.WebData (List RPWeb.Models.InProcessRO)"],"Roll":["RPWeb.RollMsgs.RollMsg"],"Refresh":["Int"]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
